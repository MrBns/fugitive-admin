...
>(({ asChild, children, ...props }, ref) => {
  ...
  return (
    <AlertDialogPrimitive.Trigger ref={ref as React.Ref<HTMLButtonElement>} {...props}>
      {children}
    </AlertDialogPrimitive.Trigger>
  )
})
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Popup
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[starting-style]:animate-in data-[ending-style]:animate-out data-[ending-style]:fade-out-0 data-[starting-style]:fade-in-0 data-[ending-style]:zoom-out-95 data-[starting-style]:zoom-in-95 sm:rounded-lg",
        className
      )}
      {...props}
    />
